...
export const ja = {
  ...
  meta: {
    ...
    feedback: {
      title: "フィードバック - Nora",
      description: "Nora へのフィードバックを投稿し、要望に投票し、次に検討される改善を確認できます。",
    },
    home: {
  ...
  feedback: {
    ...
    auth: {
      signInRequired: "フィードバック投稿や投票は、Header からログインしてから行ってください。",
    },
    categories: {
      all: "すべて",
      closed: "クローズ済み",
    ...
    contributors: {
      empty: "フィードバックが投稿されると、参加者がここに表示されます。",
      title: "参加者",
    },
    detail: {
      adminAdd: "管理者を追加",
      adminAddedBy: "追加した人",
      adminAdding: "追加中...",
      adminHelp: "管理者はフィードバックを GitHub Issue に昇格し、他の GitHub ユーザーを管理者にできます。",
      adminInputLabel: "GitHub ユーザー名",
      adminInputPlaceholder: "octocat",
      adminListEmpty: "管理者はまだいません。",
      adminsTitle: "管理者",
      attachments: "添付ファイル",
      back: "フィードバック一覧へ戻る",
      commentLabel: "コメント",
      commentPlaceholder: "背景、再現手順、関連リンク、判断内容を追加してください。",
      commentSubmit: "コメントを投稿",
      commentSubmitting: "投稿中...",
      comments: "コメント",
      emptyComments: "まだコメントはありません。",
      issueLink: "GitHub Issue を開く",
      promote: "GitHub Issue に昇格",
      promoteComplete: "GitHub Issue に昇格済み",
      promoteHint: "管理者は、対応が必要なフィードバックを nora-release/nora に昇格できます。",
      promoting: "昇格中...",
    },
    empty: {
      description: "まずは、作業フロー、モデルプロバイダー、デスクトップ体験で一番気になる点から共有してください。",
      title: "一致するフィードバックはまだありません。",
    },
    eyebrow: "フィードバック",
    form: {
      attachmentHelp: "スクリーンショット、ログ、短い動画を添付できます。最大 5 ファイル、各 5 MB まで。",
      ...
      title: "フィードバックを共有",
      titleLabel: "タイトル",
      titlePlaceholder: "要望や不具合を短く書く",
    },
    intro:
      "Nora に次に改善してほしいことを教えてください。要望の投稿、不具合の報告、既存フィードバックへの投票ができます。",
    listTitle: "フィードバック",
    loading: "フィードバックを読み込んでいます...",
    searchPlaceholder: "フィードバックを検索",
    signInPanel: {
      description: "GitHub でログインすると投稿と投票ができます。公開フィードバックは誰でも閲覧できます。",
      title: "ログインして参加",
    },
    sort: {
      new: "新着",
